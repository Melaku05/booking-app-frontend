            ...
            <form onSubmit={(e) => handleSubmit(e)}>
              ...
              <div className="w-full mt-6">
                <div className="relative flex items-center justify-center">
                  <input aria-label="enter Password" type={passwordType} onChange={handlePasswordChange} value={passwordInput} className="w-full py-3 pl-3 mt-2 text-xs font-medium leading-none text-gray-800 bg-gray-200 border rounded-full focus:outline-none" placeholder="Enter Password" />
                  <button type="button" onClick={togglePassword} className="absolute right-0 mt-2 mr-3 cursor-pointer">
