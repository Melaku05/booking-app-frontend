...
const NavigationReserve = () => {
  ...
  return (
    <div>
      <div className="bg-menu rounded-r shadow xl:hidden flex justify-between w-full p-6 items-center border border-transparent ">
        <button type="button" className="flex text-white hover:text-doctor focus:outline-none focus:text-indigo-200 justify-between items-center space-x-3">
          <div aria-label="toggler" className="fixed flex justify-center items-center">
      ...
      <div id="Main" className={`${show ? '-translate-x-full' : 'translate-x-0'} bg-indigo-700 transform  xl:translate-x-0 shadow xl:rounded-r fixed h-full top-22 sm:z-20 bg-white  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 flex-col `}>
        <button type="button" className="hidden focus:outline-none hover:text-indigo-200 focus:text-indigo-200 text-white sm:flex justify-start p-6 items-center space-x-3  w-full">
          <span className="text-xl flex leading-6 text-menu justify-between items-center">
            Booking
        ...
        <div className=" mt-4 flex flex-col px-6 justify-start items-center  px-4 w-full   ">
          <button type="button" className="focus:outline-none focus:bg-menu  flex jusitfy-start hover:bg-menu text-black font-bold rounded py-3  items-center space-x-6 w-full ">
            ...
            <p className="text-black font-bold leading-4 border-b border-transparent hover:border-doctor focus:border-doctor">DOCTORS</p>
          </button>
          <button type="button" className="focus:outline-none focus:bg-menu  flex jusitfy-start text-black font-bold hover:bg-menu rounded py-3  items-center space-x-6 w-full ">
            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <p className="text-black font-bold leading-4 border-b border-transparent  hover:border-doctor focus:border-white  ">RESERVE</p>
          </button>
          <button type="button" className="focus:outline-none focus:bg-menu  flex jusitfy-start  hover:bg-menu text-black font-bold rounded py-3 items-center space-x-6 w-full ">
            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <p className="text-black font-bold leading-4 border-b border-transparent  hover:border-doctor focus:border-white  ">MY RESERVATIONS</p>
          </button>
          <button type="button" className="focus:outline-none focus:text-700 flex justify-start items-center space-x-6 text-red-500 font-bold hover:text-red-600 rounded  py-3  w-full ">
            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-danger leading-4 border-b border-transparent">Logout</p>
          </button>
          <div className="shadow mt-3 w-full p-4 bg-doctor  flex jusitfy-start items-start flex-col rounded">
            <p className="text-base leading-none text-black font-bold">Booking Capacity</p>
        ...
        <div className="pb-8 mx-6 pt-6 flex justify-start items-center space-x-2 ">
          ...
          <div className="flex flex-col jusitfy-start items-start space-y-1">
            <p className="cursor-pointer text-base leading-4 text-white">Test Patient</p>
            <p className="cursor-pointer text-xs leading-3 text-orange-200">test@gmail.com</p>
          </div>
        </div>
      </div>
    </div>
