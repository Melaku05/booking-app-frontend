  ...
  return (
    <div>
      ...
      <div id="Main" className={`${show ? 'translate-x-0' : '-translate-x-full'} mt-24 xl:mt-0 bg-navbar border  xl:translate-x-0 shadow xl:rounded fixed h-full top-22 sm:z-20 bg-white transform  ease-in-out xl:ease-linear  transition duration-500 flex justify-start items-start w-full xl:w-64 flex-col `}>
        ...
        <div className="flex  flex-col items-start mt-60 justify-start pt-6 pb-8 mx-6 space-x-2 ">
          <div>
            <img src="https://i.ibb.co/54vKnF3/Ellipse-3.png" alt="avatar" />
          </div>
          <div className="flex flex-col border items-start space-y-1 jusitfy-start">
            <p className="text-xs leading-3 font-bold text-gray-500 cursor-pointer capitalize">{userInfo.user.username}</p>
          </div>

          <div className="flex  justify-start border md:justify-end items-start  w-full md:w-auto md:items-center space-x-6 ">
