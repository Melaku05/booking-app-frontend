    ...
    <div>
      ...
      <div id="Main" className={`${show ? '-translate-x-0' : 'translate-x-full'} bg-navbar border transform  xl:translate-x-0 shadow xl:rounded-r fixed h-full top-22 sm:z-20 bg-white  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 md:w-full xl:w-64 flex-col `}>
        ...
        <div className="flex flex-col items-center justify-start w-full px-4 px-6 mt-4 ">
          ...
          <button onClick={() => dispatch(signOut())} type="button" className="flex items-center justify-start w-full py-3 space-x-6 font-bold text-red-500 rounded focus:outline-none focus:text-700 hover:text-red-600 ">
            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
